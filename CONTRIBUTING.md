...
[GitHub Issues page](https://github.com/Open-CMSIS-Pack/vscode-cmsis-sds/issues) to start the discussion about your proposal.
...
[GitHub repository](https://github.com/Open-CMSIS-Pack/vscode-cmsis-sds/pulls) to:
   - Provide a bug fix
...
Please feel free to raise an [issue on GitHub](https://github.com/Open-CMSIS-Pack/vscode-cmsis-sds/issues)
...
We use labels to classify and filter issues. See the [available set of labels](https://github.com/Open-CMSIS-Pack/vscode-cmsis-sds/labels).
...
You can submit a pull request at our [GitHub Pull Requests page](https://github.com/Open-CMSIS-Pack/vscode-cmsis-sds/pulls).
